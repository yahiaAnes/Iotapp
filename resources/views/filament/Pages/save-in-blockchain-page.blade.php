                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                            @foreach ($crops as $crop)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200 {{ $highlightCropId == $crop->id ? 'bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 border-l-4 border-yellow-400' : 'bg-white dark:bg-gray-800' }}" data-id="{{ $crop->id }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-full text-white shadow-sm
                                            @if($crop->status === 'stored') bg-gradient-to-r from-green-500 to-green-600
                                            @elseif($crop->status === 'pending') bg-gradient-to-r from-yellow-500 to-yellow-600
                                            @elseif($crop->status === 'draft') bg-gradient-to-r from-gray-500 to-gray-600
                                            @else bg-gradient-to-r from-red-500 to-red-600 @endif">
                                            @if($crop->status === 'stored')
