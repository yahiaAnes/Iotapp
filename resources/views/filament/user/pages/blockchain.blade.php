<x-filament-panels::page>
          ...
          <table id="cropsTable" class="min-w-full">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
              @foreach ($this->crops as $crop)
                <tr data-id="{{ $crop['id'] }}" class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">{{ $crop['name'] }}</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">{{ $crop['planting_date'] }}</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">{{ $crop['harvest_date'] }}</td>
                  <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200">
                      {{ $crop['fertilizers_used'] }}
                    </span>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">{{ $crop['farm']['name'] ?? 'N/A' }}</td>
                  <td class="px-6 py-4 whitespace-nowrap text-center">
                    <button onclick="sendCropToAdmin({{ $crop['id'] }})" 
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-center">
                    <button onclick="generateQR(this)" data-crop-id="{{ $crop['id'] }}" 
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
              @foreach ($this->farms as $farm)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">{{ $farm['name'] }}</td>
  ...
  <div id="customFieldModal-{{ $crop['id'] }}" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center hidden z-50 backdrop-blur-sm">
    <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl w-full max-w-md mx-4 border border-gray-200 dark:border-gray-700">
      ...
      <div class="space-y-4">
        <input type="text" id="customFieldName-{{ $crop['id'] }}" placeholder="Information Name" 
        ...
        <input type="text" id="customFieldValue-{{ $crop['id'] }}" placeholder="Information Value" 
               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100 transition-colors">
      </div>
      <div class="flex justify-end gap-3 mt-8">
        <button onclick="addCustomField('{{ $crop['id'] }}')" 
        ...
        <button onclick="closeCustomFieldModal('{{ $crop['id'] }}')" 
